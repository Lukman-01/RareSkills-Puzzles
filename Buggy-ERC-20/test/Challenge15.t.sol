...
contract Challenge15Test is Test {
    ...
    function testMintAndValidationBugs() public {
        ...
        // balanceOf mapping is at slot 3 (name=0, symbol=1, decimals=immutable, totalSupply=2, balanceOf=3)
        vm.store(
            address(token),
            keccak256(abi.encode(alice, uint256(3))), // balanceOf mapping at slot 3
